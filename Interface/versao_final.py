...
class tkinterApp(tk.Tk):
    ...
    def show_frame(self, cont):
        ...
        if cont==Menu_Pedidos:
            ...
            for widget in frame_conta.winfo_children():
                widget.pack_forget()
        elif cont==Inserir_Nome and inicio==True:
            inicio=False
            nome_var=tk.StringVar()
            nome_entry.config(textvariable=nome_var)
        elif cont==Pagar:
            label_pedidos_nome.config(text=('PEDIDOS DE %s' % nome))
...
class Inserir_Nome(tk.Frame):
    def __init__(self, parent, controller): 
        ...
        global nome, nome_var, nome_entry
        ...
        frame_inserir_nome=tk.Frame(self, bg='#926956', bd=2)
        frame_inserir_nome.config(width= 400, height=200)
        frame_inserir_nome.place(anchor='c', relx=0.5, rely=0.5)
        frame_inserir_nome.grid_propagate(0)
        
        nome_label = tk.Label(frame_inserir_nome, text = 'Insira seu nome:', font=('calibre',25, 'bold'), fg="#FDF3DC", bg='#926956')
        nome_label.pack(side='top')

        nome_entry = tk.Entry(frame_inserir_nome, textvariable = nome_var, font=('calibre',25), bg='#FDF3DC', fg='#70391F')
        nome_entry.pack(side='top')
        nome=nome_var.get()

        confirmar_btn=tk.Button(frame_inserir_nome,text = 'Confirmar', font = ('calibre',20), bg='#FDF3DC', fg='#70391F',
...
class Menu_Pedidos(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label_pedidos = tk.Label(frame_pedidos, font=('calibre',25, 'bold'), bg='#F6C7B3', fg='#CE724B')
        ...
        def ad_prato (cardapio, prato, label, btn):
            ...
            if prato in pedidos_da_comanda:
                ...
                btn.pack(side='top')
                btn.config(text='Remover', font = ('calibre',14), bg='#FFE3D7', fg="#CE724B", pady=3)
        ...
        cardapio_doces={'Bomba de Chocolate':[6.90, '/home/stella/Downloads/cafeteria/bombadechoco.png', 'Bomba de\nChocolate'], 'Croissant de Chocolate':[7.50, '/home/stella/Downloads/cafeteria/croissantchoco.png', 'Croissant de\nChocolate'], 'Torta de Limão':[8.90, '/home/stella/Downloads/cafeteria/tortadelimao.png', 'Torta de Limão'], 
                'Macaron':[4.50, '/home/stella/Downloads/cafeteria/macaron.png', 'Macaron'], 'Cookie de Chocolate':[5.00, '/home/stella/Downloads/cafeteria/cookie.png', 'Cookie de\nChocolate'], 'Banoffee':[9.90, '/home/stella/Downloads/cafeteria/banofe.png', 'Banoffee'], 
                'Donut com Cobertura':[6.00, '/home/stella/Downloads/cafeteria/donut.png', 'Donut com\nCobertura'], 'Bolo de Cenoura com Chocolate':[7.00, '/home/stella/Downloads/cafeteria/bolo_cenoura.jpg', 'Bolo de Cenoura\ncom Chocolate'], 'Cupcake Red Velvet':[6.50, '/home/stella/Downloads/cafeteria/cupcake.png', 'Cupcake\nRed Velvet'],
                }
        cardapio_salgados={'Croissant':[7.49, '/home/stella/Downloads/cafeteria/croissant.png', 'Croissant'], 'Sanduíche Natural':[9.90, '/home/stella/Downloads/cafeteria/sanduichenat.png', 'Sanduíche Natural'], 'Coxinha de Frango':[4.90, '/home/stella/Downloads/cafeteria/coxinha.png', 'Coxinha de Frango'], 
                'Calzone de carne moída':[5.35, '/home/stella/Downloads/cafeteria/calzone.png', 'Calzone de\ncarne moída'], 'Crepioca com Cottage':[8.80, '/home/stella/Downloads/cafeteria/crepioca.png', 'Crepioca\ncom Cottage'], 'Torrada com pasta de atum':[7.49, '/home/stella/Downloads/cafeteria/torrada.png', 'Torrada com\npasta de atum'], 
                'Esfiha de carne':[5.50, '/home/stella/Downloads/cafeteria/esfirra.png', 'Esfiha de carne'], 'Quiche de alho poró':[9.50, '/home/stella/Downloads/cafeteria/quiche.png', 'Quiche de alho poró'], 'Omelete de 3 queijos':[9.90, '/home/stella/Downloads/cafeteria/omelete.png', 'Omelete de\n3 queijos'],
                }
        cardapio_bebidas={'Café Espresso':[4.00, '/home/stella/Downloads/cafeteria/espresso.png', 'Café Espresso'], 'Cappuccino':[6.50, '/home/stella/Downloads/cafeteria/capuccino.png', 'Cappuccino'], 'Café Latte':[6.90, '/home/stella/Downloads/cafeteria/cafelatte.png', 'Café Latte'], 
                'Chá Verde':[5.00, '/home/stella/Downloads/cafeteria/chaverde.png', 'Chá Verde'], 'Iced Coffee':[7.00, '/home/stella/Downloads/cafeteria/icedcoffee.png', 'Iced Coffee'], 'Vitamina de Banana com Aveia':[8.50, '/home/stella/Downloads/cafeteria/vitamina.png', 'Vitamina de\nBanana com Aveia'], 
                'Suco Natural de Laranja':[6.00, '/home/stella/Downloads/cafeteria/sucodelaranja.png', 'Suco Natural\nde Laranja'], 'Iogurte com Frutas Vermelhas':[7.90, '/home/stella/Downloads/cafeteria/iogurte.png', 'Iogurte com\nFrutas Vermelhas'], 'Bobba Tea (Chá com Pérolas)':[9.50, '/home/stella/Downloads/cafeteria/bobbatea.png', 'Bobba Tea\n(Chá com Pérolas)'],
                }
...
class Pagar(tk.Frame):
    def __init__(self, parent, controller): 
        ...
        global nome, nome_var, nome_entry, pedidos_da_comanda, label_pedidos_nome, label_valor_final, frame_pagar, frame_conta
        ...
        frame_conta.place(anchor='center', relwidth=0.75, relheight=0.78, relx=0.5, rely=0.5)

        label_pedidos_nome = tk.Label(frame_pagar, font=('calibre',25, 'bold'), bg='#F6C7B3', fg='#CE724B')
        label_pedidos_nome.pack(side='top', pady=20)
